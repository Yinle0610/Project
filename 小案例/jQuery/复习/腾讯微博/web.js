...
$(function () {
    ...
    $("#msgTxt").text($("#msgTxt").text()+"["+txt+"]");
    });
    var Top = $(".insertFace").offsetTop;
    var left = $(".insertFace").offsetLeft;
    $faceDiv.css(
        {
            "top":top+20,
            "left":left - 10
